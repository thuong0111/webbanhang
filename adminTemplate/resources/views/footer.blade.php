            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <h4 id="name-product" class="mtext-105 cl2 js-name-detail p-b-14">
                        </h4>

                        <span id="pricesale-product" class="mtext-106 cl2">
                        </span>

                        <p id = "content-product" class="stext-102 cl3 p-t-23">
                        </p>
